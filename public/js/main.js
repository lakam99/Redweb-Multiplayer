...
onClick(() => {
  const dir = mousePos().sub(localPlayer.pos).unit();
  const bullet = spawnBullet(localPlayer.pos, dir, "bullet", localPlayer.id);
  handleBulletCollision(bullet, localPlayer.id, (targetId) => {
